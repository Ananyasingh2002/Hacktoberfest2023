...
def load_assests():
    ...
    """
    # To load spaceship images into the file known as surfaces to use this above background
...
def yellow_handle_movement(keys_pressed, yellow, VELOCITY, BORDER):
    ...
    |       W        |     UP      |
    |       S        |     DOWN    |
    |   Left SHFT    |     FIRE    |   in handle_bullets function
    +----------------+-------------+
    ...
    """
    # To check that it remains in the screen and doesn't crosses the border
...
def red_handle_movement(keys_pressed, red, VELOCITY, BORDER):
    ...
    |  Up Arrow      |     UP      |
    |  Down Arrow    |     DOWN    |
    |  Right SHFT    |     FIRE    |  in handle_bullets function
    +----------------+-------------+
    :param keys_pressed: Gives which keys are pressed on keyboard.
...
def winner(text, WIN):
    ...
    # To display the winner font on the screen.
